...
export interface StorageType extends BaseStorageType {
    acalaOracle: {
         ...
         **/
        isUpdated: StorageMap<OracleKey | {
            Token: any;
        } | {
            DEXShare: any;
        } | {
        ...
        values: StorageMap<OracleKey | {
            ...
            StableAssetPoolToken: any;
        } | string, Option<TimestampedValueOf>>;
    };
    auction: {
        /**
    ...
    auctionManager: {
         ...
         **/
        totalCollateralInAuction: StorageMap<CurrencyId | {
            Token: any;
        } | {
            DEXShare: any;
        } | {
    ...
    authority: {
        nextTaskIndex: ScheduleTaskIndex | null;
    };
    authorship: {
    ...
    cdpEngine: {
        collateralParams: StorageMap<CurrencyId | {
            Token: any;
        } | {
            DEXShare: any;
        } | {
         ...
         **/
        debitExchangeRate: StorageMap<CurrencyId | {
            Token: any;
        } | {
            DEXShare: any;
        } | {
    ...
    cdpTreasury: {
         ...
         **/
        expectedCollateralAuctionSize: StorageMap<CurrencyId | {
            Token: any;
        } | {
            DEXShare: any;
        } | {
    ...
    honzon: {};
    incentives: {
        dexSavingRewardRate: StorageMap<PoolId | {
            Loans: any;
        } | {
            Dex: any;
        } | string, Rate>;
         ...
         **/
        incentiveRewardAmount: StorageMap<PoolId | {
            Loans: any;
        } | {
            Dex: any;
        } | string, Balance>;
         ...
         **/
        payoutDeductionRates: StorageMap<PoolId | {
            Loans: any;
        } | {
            Dex: any;
        } | string, Rate>;
    ...
    loans: {
         ...
         **/
        totalPositions: StorageMap<CurrencyId | {
            Token: any;
        } | {
            DEXShare: any;
        } | {
    ...
    prices: {
        lockedPrice: StorageMap<CurrencyId | {
            Token: any;
        } | {
            DEXShare: any;
        } | {
