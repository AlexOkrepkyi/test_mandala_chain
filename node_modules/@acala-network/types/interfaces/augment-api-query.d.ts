...
declare module '@polkadot/api/types/storage' {
    interface AugmentedQueries<ApiType> {
        acalaOracle: {
             ...
             **/
            isUpdated: AugmentedQuery<ApiType, (arg: OracleKey | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
            ...
            } | string | Uint8Array) => Observable<bool>, [OracleKey]> & QueryableStorageEntry<ApiType, [OracleKey]>;
            /**
             * Raw values for each oracle operators
             **/
            rawValues: AugmentedQuery<ApiType, (arg1: AccountId | string | Uint8Array, arg2: OracleKey | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array) => Observable<Option<TimestampedValueOf>>, [AccountId, OracleKey]> & QueryableStorageEntry<ApiType, [AccountId, OracleKey]>;
            /**
             * Combined value, may not be up to date
             **/
            values: AugmentedQuery<ApiType, (arg: OracleKey | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array) => Observable<Option<TimestampedValueOf>>, [OracleKey]> & QueryableStorageEntry<ApiType, [OracleKey]>;
            /**
             * Generic query
             **/
        ...
        auctionManager: {
             ...
             **/
            totalCollateralInAuction: AugmentedQuery<ApiType, (arg: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
        ...
        cdpEngine: {
             ...
             **/
            collateralParams: AugmentedQuery<ApiType, (arg: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array) => Observable<RiskManagementParams>, [CurrencyId]> & QueryableStorageEntry<ApiType, [CurrencyId]>;
            /**
             ...
             **/
            debitExchangeRate: AugmentedQuery<ApiType, (arg: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array) => Observable<Option<ExchangeRate>>, [CurrencyId]> & QueryableStorageEntry<ApiType, [CurrencyId]>;
            /**
        ...
        cdpTreasury: {
             ...
             **/
            expectedCollateralAuctionSize: AugmentedQuery<ApiType, (arg: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
        ...
        honzon: {
             ...
             **/
            authorization: AugmentedQuery<ApiType, (arg1: AccountId | string | Uint8Array, arg2: ITuple<[CurrencyId, AccountId]> | [CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array, AccountId | string | Uint8Array]) => Observable<Option<Balance>>, [AccountId, ITuple<[CurrencyId, AccountId]>]> & QueryableStorageEntry<ApiType, [AccountId, ITuple<[CurrencyId, AccountId]>]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        incentives: {
             ...
             **/
            claimRewardDeductionRates: AugmentedQuery<ApiType, (arg: PoolId | {
                Loans: any;
            } | {
                Dex: any;
            } | string | Uint8Array) => Observable<Rate>, [PoolId]> & QueryableStorageEntry<ApiType, [PoolId]>;
            /**
             * Mapping from pool to its fixed reward rate per period.
             *
             * DexSavingRewardRates: map Pool => SavingRatePerPeriod
             **/
            dexSavingRewardRates: AugmentedQuery<ApiType, (arg: PoolId | {
                Loans: any;
            } | {
                Dex: any;
            } | string | Uint8Array) => Observable<Rate>, [PoolId]> & QueryableStorageEntry<ApiType, [PoolId]>;
             ...
             **/
            incentiveRewardAmounts: AugmentedQuery<ApiType, (arg1: PoolId | {
                Loans: any;
            } | {
                Dex: any;
            } | string | Uint8Array, arg2: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array) => Observable<Balance>, [PoolId, CurrencyId]> & QueryableStorageEntry<ApiType, [PoolId, CurrencyId]>;
            /**
             ...
             **/
            pendingMultiRewards: AugmentedQuery<ApiType, (arg1: PoolId | {
                Loans: any;
            } | {
                Dex: any;
            } | string | Uint8Array, arg2: AccountId | string | Uint8Array) => Observable<BTreeMap<CurrencyId, Balance>>, [PoolId, AccountId]> & QueryableStorageEntry<ApiType, [PoolId, AccountId]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        loans: {
             ...
             **/
            positions: AugmentedQuery<ApiType, (arg1: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array, arg2: AccountId | string | Uint8Array) => Observable<Position>, [CurrencyId, AccountId]> & QueryableStorageEntry<ApiType, [CurrencyId, AccountId]>;
            /**
             ...
             **/
            totalPositions: AugmentedQuery<ApiType, (arg: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array) => Observable<Position>, [CurrencyId]> & QueryableStorageEntry<ApiType, [CurrencyId]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        prices: {
             ...
             **/
            lockedPrice: AugmentedQuery<ApiType, (arg: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array) => Observable<Option<Price>>, [CurrencyId]> & QueryableStorageEntry<ApiType, [CurrencyId]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        rewards: {
             ...
             * map PoolId => PoolInfo
             **/
            poolInfos: AugmentedQuery<ApiType, (arg: PoolId | {
                Loans: any;
            } | {
                Dex: any;
            } | string | Uint8Array) => Observable<PoolInfo>, [PoolId]> & QueryableStorageEntry<ApiType, [PoolId]>;
            /**
             ...
             **/
            sharesAndWithdrawnRewards: AugmentedQuery<ApiType, (arg1: PoolId | {
                Loans: any;
            } | {
                Dex: any;
            } | string | Uint8Array, arg2: AccountId | string | Uint8Array) => Observable<ITuple<[Share, BTreeMap<CurrencyId, Balance>]>>, [PoolId, AccountId]> & QueryableStorageEntry<ApiType, [PoolId, AccountId]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        unknownTokens: {
             ...
             **/
            abstractFungibleBalances: AugmentedQuery<ApiType, (arg1: MultiLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array, arg2: Bytes | string | Uint8Array) => Observable<u128>, [MultiLocation, Bytes]> & QueryableStorageEntry<ApiType, [MultiLocation, Bytes]>;
            /**
             ...
             * double_map: who, asset_id => u128
             **/
            concreteFungibleBalances: AugmentedQuery<ApiType, (arg1: MultiLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array, arg2: MultiLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array) => Observable<u128>, [MultiLocation, MultiLocation]> & QueryableStorageEntry<ApiType, [MultiLocation, MultiLocation]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
