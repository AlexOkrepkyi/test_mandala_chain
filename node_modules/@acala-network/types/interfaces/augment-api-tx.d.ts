...
declare module '@polkadot/api/types/submittable' {
    interface AugmentedSubmittables<ApiType> {
        ...
        cdpEngine: {
             ...
             * - `who`: CDP's owner.
             **/
            liquidate: AugmentedSubmittable<(currencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
            ...
            } | string | Uint8Array, who: LookupSource | {
                Id: any;
            } | {
                Index: any;
            } | {
                ...
                Address20: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, LookupSource]>;
            /**
             ...
             **/
            setCollateralParams: AugmentedSubmittable<(currencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array, interestRatePerSec: ChangeOptionRate | {
                NoChange: any;
            } | {
                NewValue: any;
            } | string | Uint8Array, liquidationRatio: ChangeOptionRatio | {
                NoChange: any;
            } | {
                NewValue: any;
            } | string | Uint8Array, liquidationPenalty: ChangeOptionRate | {
                NoChange: any;
            } | {
                NewValue: any;
            } | string | Uint8Array, requiredCollateralRatio: ChangeOptionRatio | {
                NoChange: any;
            } | {
                NewValue: any;
            } | string | Uint8Array, maximumTotalDebitValue: ChangeBalance | {
                NoChange: any;
            } | {
                NewValue: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, ChangeOptionRate, ChangeOptionRatio, ChangeOptionRate, ChangeOptionRatio, ChangeBalance]>;
            /**
             ...
             * - `who`: CDP's owner.
             **/
            settle: AugmentedSubmittable<(currencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
        ...
        cdpTreasury: {
            auctionCollateral: AugmentedSubmittable<(currencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array, amount: Balance | AnyNumber | Uint8Array, target: Balance | AnyNumber | Uint8Array, splited: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, Balance, Balance, bool]>;
             ...
             **/
            setExpectedCollateralAuctionSize: AugmentedSubmittable<(currencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array, size: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, Balance]>;
            /**
             * Generic tx
             **/
            [key: string]: SubmittableExtrinsicFunction<ApiType>;
        ...
        currencies: {
            sweepDust: AugmentedSubmittable<(currencyId: CurrencyIdOf | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array, accounts: Vec<AccountId> | (AccountId | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [CurrencyIdOf, Vec<AccountId>]>;
            /**
        ...
        dex: {
             ...
             * incentives
             **/
            addLiquidity: AugmentedSubmittable<(currencyIdA: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array, currencyIdB: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
             ...
             **/
            addProvision: AugmentedSubmittable<(currencyIdA: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array, amountA: Compact<Balance> | AnyNumber | Uint8Array, amountB: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, CurrencyId, Compact<Balance>, Compact<Balance>]>;
            /**
             ...
             * - `currency_id_b`: currency id B.
             **/
            claimDexShare: AugmentedSubmittable<(owner: AccountId | string | Uint8Array, currencyIdA: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, CurrencyId, CurrencyId]>;
            /**
             * Disable a `Enabled` trading pair.
             **/
            disableTradingPair: AugmentedSubmittable<(currencyIdA: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, CurrencyId]>;
            /**
             ...
             **/
            enableTradingPair: AugmentedSubmittable<(currencyIdA: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
             ...
             **/
            endProvisioning: AugmentedSubmittable<(currencyIdA: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
             ...
             **/
            listProvisioning: AugmentedSubmittable<(currencyIdA: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array, minContributionA: Balance | AnyNumber | Uint8Array, minContributionB: Balance | AnyNumber | Uint8Array, targetProvisionA: Balance | AnyNumber | Uint8Array, targetProvisionB: Balance | AnyNumber | Uint8Array, notBefore: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, CurrencyId, Balance, Balance, Balance, Balance, BlockNumber]>;
            /**
             ...
             **/
            removeLiquidity: AugmentedSubmittable<(currencyIdA: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
             ...
             **/
            swapWithExactSupply: AugmentedSubmittable<(path: Vec<CurrencyId> | (CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array)[], supplyAmount: Compact<Balance> | AnyNumber | Uint8Array, minTargetAmount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<CurrencyId>, Compact<Balance>, Compact<Balance>]>;
            /**
             ...
             **/
            swapWithExactTarget: AugmentedSubmittable<(path: Vec<CurrencyId> | (CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array)[], targetAmount: Compact<Balance> | AnyNumber | Uint8Array, maxSupplyAmount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<CurrencyId>, Compact<Balance>, Compact<Balance>]>;
            /**
             * List a new trading pair, trading pair will become Enabled status
             * after provision process.
             **/
            updateProvisioningParameters: AugmentedSubmittable<(currencyIdA: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
        ...
        honzon: {
             ...
             **/
            adjustLoan: AugmentedSubmittable<(currencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array, collateralAdjustment: Amount | AnyNumber | Uint8Array, debitAdjustment: Amount | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, Amount, Amount]>;
            /**
             ...
             **/
            authorize: AugmentedSubmittable<(currencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array, to: LookupSource | {
                Id: any;
            } | {
                Index: any;
            } | {
             ...
             **/
            closeLoanHasDebitByDex: AugmentedSubmittable<(currencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array, maxCollateralAmount: Balance | AnyNumber | Uint8Array, maybePath: Option<Vec<CurrencyId>> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, Balance, Option<Vec<CurrencyId>>]>;
            /**
             ...
             **/
            transferLoanFrom: AugmentedSubmittable<(currencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array, from: LookupSource | {
                Id: any;
            } | {
                Index: any;
            } | {
             ...
             * - `to`: authorizee account
             **/
            unauthorize: AugmentedSubmittable<(currencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
        ...
        prices: {
             ...
             **/
            lockPrice: AugmentedSubmittable<(currencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId]>;
            /**
             ...
             * - `currency_id`: currency type.
             **/
            unlockPrice: AugmentedSubmittable<(currencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
        ...
        xTokens: {
             ...
             * messages correctly.
             **/
            transfer: AugmentedSubmittable<(currencyId: CurrencyId | {
                Token: any;
            } | {
                DEXShare: any;
            } | {
                ...
                StableAssetPoolToken: any;
            } | string | Uint8Array, amount: Balance | AnyNumber | Uint8Array, dest: MultiLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array, destWeight: Weight | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, Balance, MultiLocation, Weight]>;
            /**
             * Transfer `MultiAsset`.
             *
             * `dest_weight` is the weight for XCM execution on the dest chain, and
             ...
             * messages correctly.
             **/
            transferMultiasset: AugmentedSubmittable<(asset: MultiAsset | {
                id?: any;
                fungibility?: any;
            } | string | Uint8Array, dest: MultiLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array, destWeight: Weight | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAsset, MultiLocation, Weight]>;
            /**
             * Generic tx
             **/
            [key: string]: SubmittableExtrinsicFunction<ApiType>;
