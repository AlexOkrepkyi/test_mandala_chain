...
function loanType(instanceId, api) {
  return (0, _util.memo)(instanceId, currency => {
    return (0, _rxjs.combineLatest)([api.query.cdpEngine.globalInterestRatePerSec(), api.query.cdpEngine.debitExchangeRate(currency), api.query.cdpEngine.collateralParams(currency)]).pipe((0, _operators.map)(result => {
